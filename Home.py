...
with center:
    ...
    # Render cards using native st elements + container — no raw HTML for card bodies
    # This prevents the "0" artifact from Streamlit injecting hidden elements between st.image and st.markdown
